...
set output 'p5RetainedModeVSThreejsBufferGeometry.jpg'

# Configuración de los ejes y la cuadrícula
set logscale x 2
set grid lt 1 lc rgb "#444444"

set title "Performance Comparison: p5.js Retained Mode vs three.js Buffer Geometry" font ",20" textcolor rgb "#D3D3D3"
...
set style line 1 lc rgb "#FFFF00" lw 3 pt 7  
set style line 2 lc rgb "#0044FF" lw 3 pt 7   

# Gráfica de los datos con los estilos definidos
plot "p5_retained.txt" using 1:2 with linespoints ls 1 title "p5.js Retained Mode", \
     "threejs_immediate.txt" using 1:2 with linespoints ls 2 title "three.js Buffer Geometry", \
